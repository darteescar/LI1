module Tarefa4Spec (testes_tarefa_4) where
...
testes_tarefa_4 :: Test
testes_tarefa_4 = TestLabel "Tarefa4 (atualiza)" $ test [teste01, teste02, teste03, teste04, teste05, teste06]